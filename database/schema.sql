...
INSERT INTO profiles(name,title,location,experience_years,summary) VALUES ('Rajeev Singh','Software Engineer | SDET Automation | Full-Stack Automation','India','Update exact total years','Software engineering and SDET automation profile focused on reliable test automation, APIs, databases and CI/CD.');
