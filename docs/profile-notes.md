...
- PCR System — UI Automation — Denso
- Digimach — API Automation
- Digiplan — Mobile Automation — Denso
- PMS Background Sanity Suite
- TG Minda Site / PU-12 Support
- Client Application Support — Havells / Jaguar
...
## Profile photo
A placeholder is included at `frontend/assets/profile-photo-placeholder.svg`. Replace it with `frontend/assets/profile-photo.jpg` when a professional photo is provided.
